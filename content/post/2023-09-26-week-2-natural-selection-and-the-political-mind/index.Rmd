...
From the heatmap and the barplot, we see that most games (11/21) resulted in a `tie`. Among the strategies, `backstabber` won the most games (5/21) and `forgiver` and `foolMeOnce` were the stratgies that won only 1 game. `Grumpy`, `handshaker`, and `cooperator` were the strategies that did not win any games.
